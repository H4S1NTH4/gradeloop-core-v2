...
import { DASHBOARD_WIDGETS, DashboardWidget } from "@/config/dashboard";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {allowedWidgets.map((widget) => {
                ...
                const colSpan = widget.gridSpan
                    ? `col-span-1 ${widget.gridSpan.sm ? `sm:col-span-${widget.gridSpan.sm}` : ""} ${widget.gridSpan.md ? `md:col-span-${widget.gridSpan.md}` : ""
