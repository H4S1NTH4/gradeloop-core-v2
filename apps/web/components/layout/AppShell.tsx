...
export default function AppShell({ children }: PropsWithChildren) {
  ...
  return (
    <div className="min-h-screen flex bg-[var(--background)] text-[var(--foreground)]">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-primary text-white px-2 py-1 rounded"
      >
        Skip to content
      </a>
      ...
      <div
        className={`flex-1 flex flex-col h-screen overflow-hidden ${collapsed ? "lg:pl-[72px]" : "lg:pl-[280px]"}`}
      >
        <TopBar
